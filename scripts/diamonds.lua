...
function Diamonds:update()
    ...
    for i = 1, #diamondTableRect, 1 do
        if diamondTableRect[i].y ~= nil and diamondTableRect[i].hit == false and PlayerX ~= nil then
            if PlayerX >= diamondTableRect[i].x and PlayerX <= diamondTableRect[i].x + diamondTableRect[i].width and PlayerY >= diamondTableRect[i].y and PlayerY <= diamondTableRect[i].y + diamondTableRect[i].height then
