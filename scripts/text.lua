...
function Text:storyline(select)
    ...
    texts = {
        ...
        "2-1: Mountain."..LivesInit,
        "2-2: Do fall down.",
        "2-3: Jumping required.",
        "2-4: Six spikes in a row, pass twice. ",
        ...
        "6-3: Narrow dive.",
        "6-4: Three pillars with one spike each.",
        ...
        "7-5: Keep right.",
        "8-1: Three platforms."..GravityChange..LivesInit,
